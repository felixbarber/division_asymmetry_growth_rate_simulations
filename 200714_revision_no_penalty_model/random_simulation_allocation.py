...
# # should give 198000 repeats. Run with 1500 job array.
...
np.save('/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200714_revision_no_penalty_model/outputs/derangements_1.npy',output)
