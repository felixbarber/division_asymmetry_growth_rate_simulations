...
par_vals = {'nstep': 1000, 'dt': 0.01, 'v_init': 1.0, 'modeltype': 17, 'delta': delta[0], 'lambda': l[0]}
...
np.save('/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201007_correlations_validation_theory_model_budding/outputs/derangements_1.npy',output)
