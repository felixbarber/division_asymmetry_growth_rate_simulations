...
job_number=49603316
path1='/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200331_m_testing/failed_{0}.txt'.format(job_number)
...
temp_ind1 = 1000  # changing the upper index to make it match what was previously used
...
# # should take around 6 hours. 600min.
