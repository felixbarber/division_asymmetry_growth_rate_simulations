...
job_number=50150767
path1='/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200329_revision_correlations_variable_lambda/failed_{0}.txt'.format(job_number)
...
temp_ind1 = 1400  # changing the upper index to make it match what was previously used
...
# # should take around 7 hours. 600min. 50243665
