...
job_number=4267922
path1='/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201122_inhibitor_dilution_correlations/failed_{0}.txt'.format(job_number)
...
temp_base_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201122_inhibitor_dilution_correlations/outputs/'
...
prog_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201122_inhibitor_dilution_correlations/outputs/progress_tracker_{0}.npy'.format(temp_ind)
if os.path.exists(prog_path):
    ...
    # left off
out_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201122_inhibitor_dilution_correlations/outputs/output_vals_{0}.npy'.format(temp_ind)
