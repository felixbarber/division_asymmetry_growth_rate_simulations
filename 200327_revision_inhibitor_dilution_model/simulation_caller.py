...
temp_base_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200327_revision_inhibitor_dilution_model/outputs/'
...
prog_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200327_revision_inhibitor_dilution_model/outputs/progress_tracker_{0}.npy'.format(temp_ind)
if os.path.exists(prog_path):
    ...
    # left off
out_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200327_revision_inhibitor_dilution_model/outputs/output_vals_{0}.npy'.format(temp_ind)
