...
job_number=4042729
path1='/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201005_revision_no_penalty_model_budding/failed_{0}.txt'.format(job_number)
...
temp_ind1 = 1500  # changing the upper index to make it match what was previously used 4143570
...
# # should take around 4 hours. 49846538. 4308996
...
temp_base_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201005_revision_no_penalty_model_budding/outputs/'
...
prog_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201005_revision_no_penalty_model_budding/outputs/progress_tracker_{0}.npy'.format(temp_ind)
if os.path.exists(prog_path):
    ...
    # left off
out_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/201005_revision_no_penalty_model_budding/outputs/output_vals_{0}.npy'.format(temp_ind)
