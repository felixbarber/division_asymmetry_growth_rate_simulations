...
def starting_popn(par1):
    ...
    elif par1['modeltype'] == 7 or par1['modeltype']==13 or par1['modeltype'] == 15:
...
def next_gen(index, f, t, par1,temp_ind=-1):
    ...
    elif par1['modeltype'] == 8 or par1['modeltype']==14:  # not a budding growth morphology, simply asymmetric division.
        # Inhibitor is assumed to be distributed volumetrically.
