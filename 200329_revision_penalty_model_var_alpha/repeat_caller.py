...
job_number=50114719
path1='/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200329_revision_penalty_model_var_alpha/failed_{0}.txt'.format(job_number)
...
temp_ind1 = 1100  # changing the upper index to make it match what was previously used
...
# # should give 41000 repeats. Run with 1100 job array.
# # should take around 7 hours (500min).50156263
...
temp_base_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200329_revision_penalty_model_var_alpha/outputs/'
...
prog_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200329_revision_penalty_model_var_alpha/outputs/progress_tracker_{0}.npy'.format(temp_ind)
if os.path.exists(prog_path):
    ...
    # left off
out_path = '/n/holyscratch01/murray_lab/fbarber/20_growth_rate_project/200329_revision_penalty_model_var_alpha/outputs/output_vals_{0}.npy'.format(temp_ind)
